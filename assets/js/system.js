class System {
    ...
    Preload() {
        ...
        this.addProduct(new Product("T-shirt Golden Years", 600, "Centered gold print with vintage Adidas logo", "product-tshirt", 5, false, false));
        this.addProduct(new Product("Hoodie Korn", 800, "Black hoodie with white centered Korn logo", "product-tshirt", 0, true, true));
        ...
        this.addProduct(new Product("Jean Jacket", 2500, "Classic black jean jacket", "product-tshirt", 5, true, true));
        this.addProduct(new Product("Denim Jeans", 800, "Blue denim jeans with a slim fit", "product-tshirt", 10, true, false));
